...
inline void parseAttributeInfo(attribute_info* attributeInfo, cp_info* constantPool, std::fstream* fh, ENDIANNESS endian) {
    ...
    char* attrName = (char*)((CONSTANT_Utf8_info*)constantPool[attributeInfo->attribute_name_index - 1].info)->bytes;
