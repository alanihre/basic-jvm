...
#define STRING_INIT_METHOD_SIGNATURE "(Ljava/lang/String;)V"
...
struct StringClassFile : public ClassFile {
    StringClassFile() : ClassFile() {
        ...
        const char *valueFieldName = BUILTIN_STRING_CLASS_VALUE_FIELD;
        ...
        const char *initMethodSignatureUtf8 = STRING_INIT_METHOD_SIGNATURE;
        ...
        codeAttr->code_length = 13;
        codeAttr->code = new u1[codeAttr->code_length];
        codeAttr->code[0] = ALOAD_0;
        codeAttr->code[1] = INVOKE_SPECIAL;
        codeAttr->code[2] = 0;
        codeAttr->code[3] = 13;
        codeAttr->code[4] = ALOAD_0;
        codeAttr->code[5] = ALOAD_1;
        codeAttr->code[6] = GET_FIELD;
        codeAttr->code[7] = 0;
        codeAttr->code[8] = 11;
        codeAttr->code[9] = PUT_FIELD;
        codeAttr->code[10] = 0;
        codeAttr->code[11] = 11;
        codeAttr->code[12] = RETURN;
        ...
        cp_info *valueFieldRefNameAndTypeEntry = &constant_pool[9];
        valueFieldRefNameAndTypeEntry->tag = CONSTANT_TYPE_NAME_AND_TYPE;
        valueFieldRefNameAndTypeEntry->info = new u1[sizeof(CONSTANT_NameAndType_info)];
        auto *valueFieldRefNameAndTypeInfo = (CONSTANT_NameAndType_info *) valueFieldRefNameAndTypeEntry->info;
        valueFieldRefNameAndTypeInfo->name_index = 1;
        valueFieldRefNameAndTypeInfo->descriptor_index = 2;

        cp_info *valueFieldRefEntry = &constant_pool[10];
        valueFieldRefEntry->tag = CONSTANT_TYPE_FIELD_REF;
        valueFieldRefEntry->info = new u1[sizeof(CONSTANT_Fieldref_info)];
        auto *valueFieldRefInfo = (CONSTANT_Fieldref_info *) valueFieldRefEntry->info;
        valueFieldRefInfo->class_index = 4;
        valueFieldRefInfo->name_and_type_index = 10;

        cp_info *superInitMethodRefNameAndTypeEntry = &constant_pool[11];
        ...
        superInitMethodRefNameAndTypeInfo->descriptor_index = 14;

        cp_info *superInitMethodRefEntry = &constant_pool[12];
        ...
        superInitMethodRefInfo->name_and_type_index = 12;

        const char *superInitMethodSignatureUtf8 = DEFAULT_INIT_METHOD_SIGNATURE;
        cp_info *superInitMethodSignatureUtf8Entry = &constant_pool[13];
