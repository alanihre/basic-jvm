...
class MethodRunner {
public:
    MethodRunner(Code_attribute* code, ClassFile* classFile, std::stack<int>* operandStack, int numArgs, const int* args, StringPool *stringPool, ObjectPool *objectPool, ClassInstantiator *classInstantiator, ClassFileLookup *classFileLookup);
    void run();
